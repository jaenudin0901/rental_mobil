		...
		<table class="table  table-striped table-responsive">
			<thead>
				...
				<tr>
					...
					<td>
						<div class="row">
							<a href="<?php echo base_url('admin/data_customer/detail_customer/').$cs->aid_customer  ;?>" class="btn btn-primary mr-2"><i class="fas fa-eye"></i></a>
							<a href="<?php echo base_url('admin/data_customer/update_customer/').$cs->aid_customer  ;?>" class="btn btn-primary mr-2"><i class="fas fa-edit "></i></a>
