    ...
    <div class="col-lg-6 col-md-6">
        <div class="single-car-wrap">
            ...
            <div class="car-list-info without-bar">
               ...
               <?php 
                    if   ($mb->status =="1"){
                    echo anchor ('customer/rental/tambah_rental/'.$mb->aid_mobil,'<span class="rent-btn">Rental</span>');
                } else {
                    echo"<span class='rent-btn'> Tidak Tersedia</span>";
                }
                     ?>
                 <a href="<?php echo base_url('customer/data_mobil/detail_mobil/'.$mb->aid_mobil) ?>" class="rent-btn">Detail</a>
            </div>
        </div>
    </div>
<?php endforeach; ?>
