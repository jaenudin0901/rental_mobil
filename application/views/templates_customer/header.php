                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 d-none d-xl-block">
                        <nav class="mainmenu alignright">
                            <ul>
                                <li class=""><a href="<?php echo base_url('customer/dasboard') ?>">Beranda</a>
                                ...
                                <?php if($this->session->userdata('nama')) { ?>
                                 <li><a href="<?php echo base_url('auth/logout'); ?>">Wellcome <?php echo $this->session->userdata('nama'); ?><span>| Logout</span></a>
                                </li>
                                <?php } else { ?>
